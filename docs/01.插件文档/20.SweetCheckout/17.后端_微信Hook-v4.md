...
+ [微信 Windows 版 4.1.8.28](https://dldir1v6.qq.com/weixin/Universal/Windows/WeChatWin_4.1.8.exe)，或任何 wx_key 支持的微信版本（4.1.0.34 - 4.1.4.11）
+ [wx_key](https://github.com/ycccccccy/wx_key/releases) （现在只能使用[备份](https://mrxiaom.lanzout.com/isSE23xf50he)构建）
...
> 
> Hook 只保证在文档指定的微信版本中可用，但 v4 没有强制要求使用指定的一个微信版本，你可以尝试使用其它版本，但不保证其可用性。欢迎在 [Issues](https://github.com/MrXiaoM/SweetCheckout/issues/6) 中报告在不同微信版本中的可用性。
...
![](https://static.mcio.dev/legacy/67f3f2bce381c3632beea374.webp)
...
> 如果无法自动获取数据库路径，请手动将其设为 `(...文档路径)/xwechat_files/wxid_xxxxxxxx/db_storage/message`，Hook 软件会去从这个文件夹中，监听、读取并解密聊天数据库文件 `biz_message_*.db`，寻找支付通知。
...
![](https://static.mcio.dev/legacy/67b04a6ed0e0a243d4ff9528.webp)
...
![](https://static.mcio.dev/legacy/685b9dee58cb8da5c86fade4.webp)
...
![](https://static.mcio.dev/legacy/685b9f4758cb8da5c86fae92.webp)
:::
