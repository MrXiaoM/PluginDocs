...
资源包仅支持 `1.16+` 的 `Paper` 及其衍生服务端。非 `Paper` 服务端请自行将 `mrxiaom:sweetmail` 这个字体的内容转移到默认字体。

+ 资源包位于 `resourcepack` 文件夹
+ 插件配置位于 `SweetMail` 文件夹
...
![](https://static.mcio.dev/legacy/67c59a63d0e0a243d40add4a.webp

收件箱/发件箱界面

![](https://static.mcio.dev/legacy/680a59fe58cb8da5c8c9433b.webp
