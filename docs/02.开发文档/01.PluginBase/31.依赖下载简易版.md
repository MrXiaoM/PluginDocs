...
[![Maven Central Version](https://img.shields.io/maven-central/v/top.mrxiaom.pluginbase/library)
](https://central.sonatype.com/artifact/top.mrxiaom.pluginbase/library)  
[![Jitpack Version](https://jitpack.io/v/top.mrxiaom/PluginBase.svg)](https://jitpack.io/#top.mrxiaom/PluginBase)
...
buildscript {
    ...
    // 如需使用快照版本，可以使用 jitpack 
    // repositories.maven("https://jitpack.io")
    // dependencies.classpath("top.mrxiaom.PluginBase:LibrariesResolver-Gradle:30dc56f6a1")
}
...
dependencies {
    ...
    // 快照版本
    //implementation("top.mrxiaom.PluginBase:LibrariesResolver-Lite:$VERSION") { isTransitive = false }
}
